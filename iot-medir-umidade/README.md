...
### Linux
```shell
zip iot-medir-umidade.zip lambda.py requirements.txt
```
...
```shell
SET NOME_FUNCAO=iot-medir-umidade-lambda
SET ARQUIVO_ZIP=iot-medir-umidade.zip
...
### Linux
```shell
export NOME_FUNCAO=iot-medir-umidade-lambda
export ARQUIVO_ZIP=iot-medir-umidade-lambda.zip
