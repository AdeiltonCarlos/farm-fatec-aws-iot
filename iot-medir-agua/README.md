...
### Linux
```shell
zip iot-medir-agua.zip lambda.py requirements.txt
```
...
```shell
SET NOME_FUNCAO=iot-medir-agua-lambda
SET ARQUIVO_ZIP=iot-medir-agua.zip
...
### Linux
```shell
export NOME_FUNCAO=iot-medir-agua-lambda
export ARQUIVO_ZIP=iot-medir-agua-lambda.zip
