...
### Linux
```shell
zip iot-direcao-vento.zip lambda.py requirements.txt
```
...
```shell
SET NOME_FUNCAO=iot-direcao-vento-lambda
SET ARQUIVO_ZIP=iot-direcao-vento.zip
...
### Linux
```shell
export NOME_FUNCAO=iot-direcao-vento-lambda
export ARQUIVO_ZIP=iot-direcao-vento-lambda.zip
